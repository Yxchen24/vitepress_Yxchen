...
<img src="public\8WUra8npHkf5vbLL.webp" alt="6d7f83c8bc260095c1ab966202e9182d" style="float:left" />

2、选择 `2.7.6 版本`gTP20X3DfLM35oP9bfNArxR6UuHDEamYTd38MBTsrBM=

![image-20250206170841757](public\1VW6loFM8twS4ynF.webp)![image-20250206171727391](public\rp9OpJzzAZrKVh7v.webp)

3、修改配置文件 `application.properties`ibbBLHPWrQl9roziUnu+bBZIVr+dZrBeEkWwwoLNs3I=

![image-20250206172121084](public\WCigcDgGWELbm9qc.webp)
...
![image-20250206172631472](public\6R7k121T91iKhRNM.webp)

4、尝试启动看看是否报错

![image-20250206172844033](public\cNjE3cMpKM29Yjr4.webp)
...
![image-20250206173834242](public\7ofLJWclYIrbNYdg.webp)

如果有相关 MyBatis 的依赖需要删除

![image-20250206173909277](public\28lZosaD8jEKfzNi.webp)

2、添加到 pom.xml 之后，点击右上角的 `Load Maven Changes`KrryZFef4D1pctURMTqry3GjQ44W/xjmnRorDc4l6E8=

![image-20250206175141328](public\JatuJQik1PSciQVa.webp)
...
![image-20250206175833755](public\AqCjvU182axKuDKd.webp)
...
![image-20250206180616280](public\m2uoQ2oMQvjRrUln.webp)
...
![image-20250206181002117](public\KoYN0LNlRLS9b8A2.webp)
...
![image-20250206183332094](public\9wjw8G1lNo5XEJiy.webp)
...
![image-20250206183525301](public\hk12pFm73nCUQyfy.webp)
...
![image-20250206183614638](public\VyIi6pjxTn79HYc7.webp)

测试，只要看到下面的结果就初始化成功！q(≧▽≦q)

![image-20250206183736180](public\uXcnyxUK7eBWBGBC.webp)
...
![image-20241211111656864](public\1iq106LgBWTodooK.webp)![image-20241211111704141](public\RuvXSVjfdfkLJ02G.webp)

或者直接 Reload All from Disk 即可解决

![image-20250208232407870](public\Rwa2rBB45NGUg2aI.webp)
